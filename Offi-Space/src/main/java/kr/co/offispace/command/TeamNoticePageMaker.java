...
public class TeamNoticePageMaker {
	...
	TeamNoticeCriteria cri = new TeamNoticeCriteria();
	...
	public TeamNoticeCriteria getCri() {
		return cri;
	}

	public void setCri(TeamNoticeCriteria cri) {
		this.cri = cri;
	}
