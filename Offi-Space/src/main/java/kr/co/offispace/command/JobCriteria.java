...
public class JobCriteria {
	...
	public JobCriteria(int page, int perPageNum) {
		this.page = page;
		this.perPageNum = perPageNum;
		setStartRowNum();
	}
	public JobCriteria(int page, int perPageNum, String searchType, String keyword) {
		this.page = page;
		this.perPageNum = perPageNum;
	...
	public String toString() {
		return "JobCriteria [page=" + page + ", perPageNum=" + perPageNum + ", startRowNum=" + startRowNum
