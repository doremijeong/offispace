                ...
                <div class="col-md-6">
                	...
                	<div class="card card-info">
                        ...
                        <div class="card-body">
                        	...
                        	<div class="form-group" id="receiverList" style="height:600px;">
		                        <select id="receiverSelect" size="22" class="duallistbox" multiple="multiple" style="display: none;">
	    ...
	    window.onload=function(){
	    	...
	    	$.ajax({
	            ...
	            success:function(success){
	                ...
	                if(success) //있으면
	                {
	                	$('#receiverList').append('<select id="receiverSelect" size="22" class="duallistbox" multiple="multiple" style="display: none;"></select>');
