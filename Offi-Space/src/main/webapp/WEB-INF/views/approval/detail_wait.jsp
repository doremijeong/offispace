	...
	<section class="content">
		<div class="card card-default card-outline">
			...
			<div class="card-header d-flex justify-content-end">
				...
				&nbsp;&nbsp;
				<div class="btn-group">
					<button class="btn btn-default btn-sm" onclick="${from eq 'noti' ? 'window.close()' : 'CloseWindow()'};">닫기</button>
				</div>
			</div>
			<!-- 본문 -->
				...
				<div class="modal-body" style="margin: auto;">
						...
						<div class="col-sm-12">
							<div class="form-group row">
								<div>
									<input type="password" name="code" class="form-control form-control-md" maxlength="6" onkeypress="return fn_press(event, 'numbers');" onkeydown="fn_press_han(this);" style="ime-mode:disabled;">
								</div>
								&nbsp;&nbsp;
