      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">개인 보고함</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="card-tools">
            <div class="input-group input-group-sm">
              <select class="form-control col-sm-5" id="inputGroupSelect01" name="searchType">
				...
				<option value="rptManager">수신자</option>
              	...
              	<c:if test="${!empty reportDocList}">
              		<c:forEach items="${reportDocList}" var="reportDoc">
              			<tr  onclick="myReportDetail('${reportDoc.reportDocCode}')" style="cursor: pointer;" >
							...
							<td class="text-left">${reportDoc.reportDocTitle}</td>
							<td class="text-center">${reportDoc.managerName}&nbsp;${reportDoc.managerPosition}</td>
