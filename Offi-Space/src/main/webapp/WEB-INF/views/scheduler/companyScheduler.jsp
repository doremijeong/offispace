				...
				<div class="row mb-2">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active">회사일정</li>
						</ol>
					</div>
				</div>
			</div>
...
//     		alert('일정이 등록되었습니다.');
        ...
        var calendar = new Calendar(calendarEl, {
			<c:if test="${loginUser.getChargeCode() eq'R106'}">
	        	customButtons: {
	        	    myCustomButton: {
	        	      text: '일정등록',
	        	      click: function() {
          ...
          headerToolbar: {
            left: `<c:if test="${loginUser.getChargeCode() eq'R106'}">myCustomButton</c:if>`,
            center: 'title',
...
<div class="modal" id="modal-detail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form role="form" method="post" action="company/register.do" name="registForm">
