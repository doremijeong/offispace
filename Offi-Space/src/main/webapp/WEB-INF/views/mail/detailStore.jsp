		...
		<section class="content">
			<div class="card card-info card-outline">
				<div class="card-header">
					<div>
						<h5 class="card-title"  style="margin-top: 5px;">보관함</h5>
					</div>
					<div class="float-right">
						...
						<div class="btn-group">
							...
							<button type="button" class="btn btn-default btn-sm" data-container="body" title="reply" onclick="replyMail('${mail.mailCode}')">답장</button>
							...
							<button type="button" class="btn btn-default btn-sm" data-container="body" title="importance" onclick="backToList('store')">목록</button>
						</div>
					</div>
				</div>
				<!-- /.card-header -->
				<div class="card-body p-0">
					...
					<div class="mailbox-read-message" style="height: auto; font-size: 0.8em;">${mail.mailCont}</div>
