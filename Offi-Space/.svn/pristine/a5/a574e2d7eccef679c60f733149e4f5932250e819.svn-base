...
<!-- 								</button> -->
								...
								<!-- 쪽지 삭제 버튼 -->
								<button type="button" class="btn btn-default btn-sm" onclick="deleteMsgBtn();">
								...
								<div class="dropdown-menu dropdown-menu dropdown-menu-left">
									<a href="javascript:moveToFromBtn();" class="dropdown-item">
										<p style="font-size: 0.8em; margin: 0;">받은 쪽지함</p>
									</a>
									
									<div class="dropdown-divider" style="margin: 0;"></div>
									<a href="javascript:moveToSentBtn();" class="dropdown-item">
										<p style="font-size: 0.8em; margin: 0;">보낸 쪽지함</p>
									</a>
						...
						<div class="card-body p-0">
							...
							<table class="table table-hover table-sm msgMixedTable" style="table-layout:fixed">
									<thead>
										<tr>
											<td style="visibility:hidden;" class="text-center" width="2%"></td>
											<td style="visibility:hidden;" class="text-center" width="2%"></td>
											<td style="visibility:hidden;" class="text-center" width="2%"></td>
											<td style="visibility:hidden;" class="text-center" width="4%"></td>
											<td style="visibility:hidden;" class="text-center" width="20%"></td>
											<td style="visibility:hidden;" class="text-center" width="8%"></td>
									...
									<tbody>
										...
										<c:if test="${empty msgList}">
											<tr>
												<td colspan="6" class="text-center">휴지통에 쪽지가 없습니다.</td>
											</tr>
										</c:if>
												...
												<c:if test="${msg.msgRead eq 0}">
													<tr class="text-primary" style="font-size: 0.85em; cursor:pointer;">
														...
														<td class="mailbox-name text-center" onclick="event.cancelBubble=true"><nobr>
															<p style="margin: 2px;">${msg.msgFromName}&nbsp;${msg.msgFromPosition}</p>
														</td>
						
															<c:if test="${msg.msgFrom eq msgCri.loginUser}">
															<td class="mailbox-subject" width="100" style="text-overflow:ellipsis; overflow:hidden; white-space: nowrap;">
																 <p class="modal_msgDetail text-truncate" style="margin:2px;"><span class="badge bg-danger">sent</span>&nbsp;${msg.msgContent}</p>
															</td>
														</c:if>
														<c:if test="${msg.msgFrom ne msgCri.loginUser}">
															<td class="mailbox-subject" width="100" style="text-overflow:ellipsis; overflow:hidden; white-space: nowrap;">
