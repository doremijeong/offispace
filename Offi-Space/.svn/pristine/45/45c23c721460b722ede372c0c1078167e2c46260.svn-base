		...
		<section class="content">
			<div class="card card-info card-outline">
				<div class="card-header">
					...
					<div class="float-right">
						...
						<div class="btn-group">
							...
							<button type="button" class="btn btn-default btn-sm" data-container="body" title="importance" onclick="backToList('send')">목록</button>
						</div>
					</div>
				</div>
				<!-- /.card-header -->
				<div class="card-body p-0">
					...
					<!-- /.mailbox-controls -->
					<div class="mailbox-read-message" style="height: auto;">
				...
				<div class="card-footer">
					<div class="float-right">
						<button type="button" class="btn btn-default" onclick="moveToTrash('${mail.mailCode}')">
							<i class="far fa-trash-alt"></i>
							휴지통으로 이동
						</button>
